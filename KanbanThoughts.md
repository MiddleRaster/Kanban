...
That's all for now, though you may want to read my post on [the best way to handle bugs in Kanban](/ABA/TheMetricForSoftwareDevelopment.html#how-to-handle-bugs-in-kanban).
